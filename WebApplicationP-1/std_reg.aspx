<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="std_reg.aspx.cs" Inherits="WebApplicationP_1.std_reg" %>
...
<asp:Label runat="server" AssociatedControlID="txtStdname"><b>Task</b></asp:Label><br />
<asp:TextBox runat="server" required="required" Enabled="True" name="BrandName" ID="txtStdname" class="form-control input-sm" placeholder="task"></asp:TextBox>
    ...
    <div class="col-md-16 col-md-offset-1">
<div class="form-group">
<asp:Label runat="server" AssociatedControlID="txtfname"><b>Description</b></asp:Label><br />
<asp:TextBox runat="server" required="required" Enabled="True" name="BrandName" ID="txtfname" class="form-control input-sm" placeholder="Description"></asp:TextBox>
</div>
</div>
</div>
...
<div class="col-md-16 col-md-offset-1">
<div class="form-group">
<asp:Label runat="server" AssociatedControlID="txtregion"><b>SelectUSer</b></asp:Label><br />
<asp:DropDownList ID="txtregion" CssClass="form-control input-sm" runat="server" >
<asp:ListItem Text="User-1" />
<asp:ListItem Text="User-2" />
<asp:ListItem Text="User-3" />
...
<div class="form-group">
<asp:Button Text="Save" ID="btnsave"  CssClass="btn btn-primary btn-lg" Width="120px" runat="server" />
<asp:Button Text="Update" ID="btnupdate"  CssClass="btn btn-primary btn-lg" Width="120px" runat="server" />
<asp:Button Text="Delete" ID="btndlt"  CssClass="btn btn-primary btn-lg" Width="120px" runat="server" />
